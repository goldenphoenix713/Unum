...
Much of these units are based off:
https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e
/English_Length_Units_Graph.svg/348px-English_Length_Units_Graph.svg.png and
its parent page: https://www.wikiwand.com/en/Imperial_units as well as:
...
fl_dr_US = us_fluid_dram = new_unit("fl dr (US)",
                                    3.6966911953125 * cm**3,
                                    "Fluid Dram (US)")
ton = ton_s_uk
