...
# Volume
apothecary_fluid_drachm = fl_dr_ap = new_unit("fl drachm ap",
                                              fl_oz / 8,
                                              "Fluid Drachm")
fl_s_ap = apothecary_fl_scruple = new_unit("fl scruple ap",
                                           fl_dr_ap / 3,
                                           "Fluid Scruple")
min_ap = apothecary_minim = new_unit("minim ap", fl_s_ap / 20, "Minim")

# Mass/Weight
# some sources state that apothecary weight measure are a set of
# subdivisions of the troy system
apothecary_pound = lb_ap = new_unit("lb ap", lb_t, "Apothecary Pound")
...
dr_ap = apothecary_drachm = drachm = new_unit("dr ap",
                                              apothecary_ounce / 8,
                                              "Apothecary Drachm")
