...
knot = KNOT = new_unit('knot', NMILE / H, 'knot')
...
g0 = standard_gravity = new_unit('g0', 9.80665 * m / (s ** 2),
                                 'Standard gravity')

# Note : 'rad' defined as 1E-2 Gy as been left out because it conflicts with
